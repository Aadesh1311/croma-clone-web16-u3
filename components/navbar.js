    ...
    <div class="nav" id="nav-top">
      ...
      <div id="nav-top-left">
        ...
        <div class="dropdown">
          ...
          <div class="more-dropdown-content-tele">
            <div id="more-dropdown-content-tele-left">
              <a href="#">Air Conditioners</a>
              <a href="#">Inverter ACs</a>
              <a href="#">Portable ACs</a>
              <a href="#">Split ACs</a>
              <a href="#">Window ACs</a>
              <a href="#">Smart ACs</a>
              <a href="#">Tower ACs</a>
              <a href="#">Hot & Cold ACs</a>
              <a href="#">3 Star ACs</a>
              <a href="#">5 Star ACs</a>
              <a href="#">Croma Air Conditioners</a>
              <a href="#">Air Conditioners Accessories</a>
              <a href="#">Refrigerators & Freezers</a>
              <a href="#">Single Door Refrigerators</a>
              <a href="#">Double Door Refrigerators</a>
              <a href="#">Triple Door Refrigerators</a>
              <a href="#">Side By Side Refrigerators</a>
            </div>
  
            <div id="more-dropdown-content-tele-center">
              <a href="#">Air Purifiers</a>
              <a href="#">Air Dehumidifiers</a>
              <a href="#">Air Humidifiers</a>
              <a href="#">Smart Air Purifiers</a>
              <a href="#">Air Quality Monitors</a>
              <a href="#">Car Air Purifiers</a>
              <a href="#">Air Filters & Accessories</a>
              <a href="#">Air Coolers</a>
              <a href="#">Desert Air Coolers</a>
              <a href="#">Tower Air Coolers</a>
              <a href="#">Portable Air Coolers</a>
              <a href="#">Smart Air Coolers</a>
              <a href="#">Fans</a>
              <a href="#">Exhaust Fans</a>
              <a href="#">Pedestal Fans</a>
              <a href="#">Tower Fans</a>
              <a href="#">Wall Mount Fans</a>
      ...
      >
        ...
        <div class="carousel-cell">
          <a href="">
            <img
              class="w3-image"
              src="https://d2d22nphq0yz8t.cloudfront.net/88e6cc4b-eaa1-4053-af65-563d88ba8b26/https://media.croma.com/image/upload/v1637891062/Croma%20Assets/CMS/Category%20icon/Category%20Icons/Laptops_cd8zmr.svg/mxw_64,f_auto"
            />
            <p>Laptops</p>
          </a>
        </div>
        ...
        <div class="carousel-cell">
          <a href="">
            <img
              class="w3-image"
              src="https://d2d22nphq0yz8t.cloudfront.net/88e6cc4b-eaa1-4053-af65-563d88ba8b26/https://media.croma.com/image/upload/v1637891065/Croma%20Assets/CMS/Category%20icon/Category%20Icons/Washing_Machine_zrwd8d.svg/mxw_64,f_auto"
            />
        ...
        <div class="carousel-cell">
          <a href="">
            <img
              class="w3-image"
              src="https://d2d22nphq0yz8t.cloudfront.net/88e6cc4b-eaa1-4053-af65-563d88ba8b26/https://media.croma.com/image/upload/v1637891062/Croma%20Assets/CMS/Category%20icon/Category%20Icons/Grooming_tuasmh.svg/mxw_64,f_auto"
            />
            <p>Grooming</p>
          </a>
        </div>
        ...
        <div class="carousel-cell">
          <a href="">
            <img
              class="w3-image"
              src="https://d2d22nphq0yz8t.cloudfront.net/88e6cc4b-eaa1-4053-af65-563d88ba8b26/https://media.croma.com/image/upload/v1637891063/Croma%20Assets/CMS/Category%20icon/Category%20Icons/Tablet_r0yxrc.svg/mxw_64,f_auto"
            />
            <p>Tablets</p>
          </a>
        </div>
        ...
        <div class="carousel-cell">
          <a href="">
            <img
              class="w3-image"
              src="https://d2d22nphq0yz8t.cloudfront.net/88e6cc4b-eaa1-4053-af65-563d88ba8b26/https://media.croma.com/image/upload/v1637891060/Croma%20Assets/CMS/Category%20icon/Category%20Icons/Cameras_e6dimt.svg/mxw_64,f_auto"
            />
            <p>Cameras</p>
          </a>
        </div>
        ...
        <div class="carousel-cell">
          <a href="">
            <img
              class="w3-image"
              src="https://d2d22nphq0yz8t.cloudfront.net/88e6cc4b-eaa1-4053-af65-563d88ba8b26/https://media.croma.com/image/upload/v1637891062/Croma%20Assets/CMS/Category%20icon/Category%20Icons/Gaming_Console_nh64os.svg/mxw_64,f_auto"
            />
            <p>Gaming</p>
          </a>
        </div>
